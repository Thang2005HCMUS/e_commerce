...
jobs:
    ...
    steps:
      ...
      - name: Upload Jacoco Report
        ...
        with:
          ...
          path: {service}/build/reports/jacoco/test/jacocoTestReport.xml
          retention-days: 1
  ...
  SonarCloud:
    ...
    steps:
      ...
      - name: Analyze with SonarCloud (CLI Mode)
        ...
        with:
          ...
          args: >
            ...
            -Dsonar.projectName="Yas {service_cap} Service"
  ...
  Check-Coverage:
    ...
    steps:
      ...
      - name: Download Jacoco Report
        ...
        with:
          name: jacoco-report-{service}
          path: build/jacoco-results
      - name: Add coverage report to PR
        id: jacoco_report
        uses: madrapps/jacoco-report@v1.6.1
        with:
          paths: ${{{{github.workspace}}}}/build/jacoco-results/jacocoTestReport.xml
